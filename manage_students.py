...
class ManageStudentsApp:
    def __init__(self, parent_frame):
        ...
        tk.Label(self.parent, text="QUẢN LÝ SINH VIÊN", font=("Arial", 16, "bold"), bg="#f4f6f9").pack(pady=10)

        form_frame = tk.LabelFrame(self.parent, text="Thông tin Sinh viên", font=("Arial", 10), bg="#f4f6f9", padx=10, pady=10)
        form_frame.pack(fill=tk.X, padx=10, pady=5)

        tk.Label(form_frame, text="Mã SV:", bg="#f4f6f9").grid(row=0, column=0, padx=5, pady=5, sticky=tk.W)
